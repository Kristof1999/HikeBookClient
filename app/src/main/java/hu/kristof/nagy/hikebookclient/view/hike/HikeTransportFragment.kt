...
class HikeTransportFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.roadRes.observe(viewLifecycleOwner) { road ->
            ...
            val nodeIcon = resources.getDrawable(org.osmdroid.wms.R.drawable.marker_default)
            for (i in road.mNodes.indices) {
                ...
                nodeMarker.subDescription = Road.getLengthDurationText(requireContext(), node.mLength, node.mDuration)
